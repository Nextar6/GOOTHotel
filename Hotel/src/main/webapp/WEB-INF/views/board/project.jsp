...
<%@ include file="header.jspf"%>
	<br>
<h1 style="float: left; color: white;">프로젝트</h1>
		...
		<tbody>
			<c:forEach var="vo" items="${projectList }">
				<tr>
					<td>${vo.projectNo }</td>
					<td><a
										href="project-detail?projectNo=${vo.projectNo}&page=${pageMaker.criteria.page}">${vo.projectTitle }</a></td>
					<td>${vo.writer }</td>
					<fmt:formatDate value="${vo.projectCdate }"
										pattern="yyyy-MM-dd HH:mm:ss" var="projectCdate" />
					<td>${projectCdate }</td>
				</tr>
